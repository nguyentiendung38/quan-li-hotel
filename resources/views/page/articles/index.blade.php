...
<section class="ftco-section ftco-no-pb" style="padding: 1em 0;">
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="search-wrap-1 ftco-animate p-8">
                            ...
                            <div class="col-md-9">
                                <div class="form-group p-4 border-0">
                                    <div class="form-field">
                                        ...
                                        <input type="text" name="key_search" class="form-control" placeholder="Nhập từ khóa tìm kiếm...">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 d-flex">
                                <div class="form-group d-flex w-100 border-0">
                                    <div class="form-field w-100 align-items-center d-flex">
                                        <button type="submit" class="align-self-stretch form-control btn btn-primary">Tìm kiếm</button>
                                    </div>
                                </div>
                            </div>
                        </div>
