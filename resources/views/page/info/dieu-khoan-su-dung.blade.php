...
<div class="container my-5 px-3">
    <section>
        ...
        <p>Trang này nêu rõ các điều khoản, điều kiện và quy định sử dụng dịch vụ của Du Lịch Huế. Khách hàng vui lòng đọc kỹ trước khi sử dụng dịch vụ.</p>
        <hr>
        ...
        <h4>1.1. Đồng ý với các điều khoản sử dụng:</h4>
        <p>
        ...
        <h4>1.2. Các thông tin hiển thị:</h4>
        <p>
        ...
        <h3>2. Chính sách bảo hành/bảo trì</h3>
        <p>
        ...
        <p>
            Mixivivu.com và các nhà cung cấp khác cũng từ chối trách nhiệm hay đưa ra đảm bảo rằng website sẽ không có lỗi vận hành, an toàn, không bị gián đoạn hay bất cứ đảm bảo nào về tính chính xác, đầy đủ và đúng hạn của các thông tin hiển thị.
        </p>
        <p>
            Khi truy cập vào website này, quý khách mặc nhiên đồng ý rằng Mixivivu, các nhà cung cấp khác cũng với đối tác liên kết không chịu bất cứ trách nhiệm nào liên quan đến thương tật, mất mát, khiếu kiện, thiện hại trực tiếp hoặc gián tiếp do không lường trước dưới bất kỳ hình thức nào phát sinh hay có liên quan đến việc:
        </p>
        <ul>
            <li>Sử dụng các thông tin trên website này</li>
            <li>Các truy cập kết nối từ website này</li>
            <li>Đăng ký thành viên, đăng ký nhận thư điện tử hay tham gia chương trình khách hàng thường xuyên</li>
            <li>Các hạn chế liên quan đến đặt chỗ trực tuyến mô tả tại đây.</li>
        </ul>
        <p>Các điều kiện và hạn chế nêu trên chỉ có hiệu lực trong khuôn khổ pháp luật hiện hành.</p>

        <h3>4. Thông tin về các sản phẩm dịch vụ</h3>
        <h4>4.1. Du thuyền Hạ Long:</h4>
        <ul>
            <li>
        ...
        <h3>5. Trách nhiệm của Ban quản lý website</h3>
        <p>
            Cam kết cung cấp cho khách hàng nội dung, thông tin đúng như các nhà cung cấp đã đưa ra.<br>
            Tư vấn, giải đáp các thắc mắc của quý khách một cách chính xác và nhanh nhất.<br>
            Bảo mật thông tin của quý khách hàng.<br>
        ...
        <h3>6. Nghĩa vụ của khách hàng khi sử dụng website</h3>
        <p>
