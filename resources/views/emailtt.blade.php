...
<head>
  ...
  <style>
    ...
    /* Header với nền gradient xanh, chữ màu trắng */
    .header {
...
<body>
  <div class="container">
    <div class="content">
      ...
      <div class="body">
        <h2>
          <b style="color:red; border:1px solid red; padding:2px 6px;">BOOKING CỦA BẠN THANH TOÁN THÀNH CÔNG</b>
        </h2>
        <!-- Thông tin Tour -->
        <div class="section">
        ...
        <div class="section">
          ...
          <p>Đã thanh toán: <b style="color:red;">{{ number_format($totalPrice, 0, ',', '.') }} vnd</b></p>
          <p>Ngày thanh toán: <b>{{$bookTour->updated_at}}</b></p>
        </div>
